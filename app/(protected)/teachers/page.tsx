                  ...
                  return (
                    ...
                    >
                      ...
                      <TableCell className="max-w-[220px]">
                        <div className="relative max-h-16 overflow-hidden [mask-image:linear-gradient(to_bottom,black_60%,transparent_100%)] text-xs text-gray-700 dark:text-gray-300">
          ...
          <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
            ...
            <div className="relative">
              ...
              {showAddClusterDropdown && clusterOptions.length > 0 && (
                <ul className="absolute z-20 mt-1 max-h-40 w-full overflow-y-auto rounded-md border border-gray-200 bg-white shadow-lg dark:border-gray-700 dark:bg-gray-800">
